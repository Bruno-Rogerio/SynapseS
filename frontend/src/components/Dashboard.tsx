...
const Dashboard: React.FC = () => {
  ...
  const menuItems: MenuItem[] = [
    { name: 'Resumo', icon: <PieChartIcon /> },
    { name: 'Gestão de Tarefas e Missões', icon: <AssignmentIcon /> },
    { name: 'Brainstorming', icon: <EmojiObjectsIcon /> },
    { name: 'Insights e Produtividade', icon: <InsightsIcon /> },
    { name: 'Indicadores', icon: <BarChartIcon /> },
    { name: 'Gerenciar Usuários', icon: <PeopleIcon /> },
    { name: 'Configurações e Segurança', icon: <SettingsIcon /> },
  ];
